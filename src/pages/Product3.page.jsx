  ...
  return (
    <>
      ...
      <ShopContext.Consumer>
        {(context) => (
          <div className="product" key={"Product-" + context.products[2].id}>
            <div className="product__wrapper">
              <div className="product__card">
                <div className="product__image">
                  <img src={context.products[2].image} alt="" />
                </div>
                <div className="product__info">
                  <p className="product__title">{context.products[2].name}</p>
                  <p className="product__weight">
                    {context.products[2].description}
                  </p>
                  <p className="product__price">
                    {context.products[2].price} СOM
                  </p>
