  ...
  return (
    <>
      ...
      <ShopContext.Consumer>
        {(context) => (
          <div className="product" key={"Product-" + context.products[8].id}>
            <div className="product__wrapper">
              <div className="product__card">
                <div className="product__image">
                  <img src={context.products[8].image} alt="" />
                </div>
                <div className="product__info">
                  <p className="product__title">{context.products[8].name}</p>
                  <p className="product__weight">
                    {context.products[8].description}
                  </p>
                  <p className="product__price">
                    {context.products[8].price} СOM
                  </p>
