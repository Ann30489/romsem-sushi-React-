  ...
  return (
    <>
      ...
      <ShopContext.Consumer>
        {(context) => (
          <div className="product" key={"Product-" + context.products[5].id}>
            <div className="product__wrapper">
              <div className="product__card">
                <div className="product__image">
                  <img src={context.products[5].image} alt="" />
                </div>
                <div className="product__info">
                  <p className="product__title">{context.products[5].name}</p>
                  <p className="product__weight">
                    {context.products[5].description}
                  </p>
                  <p className="product__price">
                    {context.products[5].price} СOM
                  </p>
