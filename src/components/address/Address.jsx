...
const Address = () => {
  ...
  return (
    <div
      ...
      style={context.cart.length > 0 ? styleNone : styleBlock}
    >
      <div className={styles.address__wrapper}>
        <Map />
        <div className={styles.address__marker__container}>
          <div className={styles.address__marker}>
            <div className={styles.address__icon}>
              <svg
                className={styles.address__svg}
                viewBox="0 0 26 38"
